      ...
      <div className="mx-auto max-w-7xl content-center text-center sm:w-[90%] lg:px-8">
        <div className="al relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center lg:items-stretch lg:justify-start">
            ...
            <div className="hidden content-center lg:ml-20 lg:block">
          ...
          <div className="inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            >
              <Cog6ToothIcon className="text-primary h-7 w-7 animate-[spin_8s_linear_infinite]" />
            </button>
            ...
            {sessionIdState ? (
              ...
              <button
                ...
                className="bg-primary ml-2 cursor-pointer rounded-lg border-none px-4 py-1 font-bold text-white transition duration-300 ease-in-out hover:scale-105"
              >
                {t(`navbar.login`)}
              </button>
            )}
